 ...
 *
 * This file is NOT mounted in the live scene. It was an experimental
 * 3D scene architecture (instanced geometry + particles + post-processing)
 * that was replaced by the modular supr/ composition system.
 *
 * The live mandala path is:
 *   AsteroidScene → supr/SuprStage → supr/LotusField (baseline) + supr/FoldField (candidate)
 *
 * Do not edit this file expecting visual changes.
 */
