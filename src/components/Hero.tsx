    ...
    <section id="hero" className="min-h-screen flex flex-col justify-center px-6 md:px-12 lg:px-24 py-32">
      <div className="max-w-5xl">
        ...
        <div className="space-y-6 text-lg md:text-xl text-[#1D1D1F] max-w-3xl leading-relaxed mb-12">
          <p>
            AI-augmented strategist with 30+ years of creative leadership, using LLMs and generative AI to accelerate research, content production, and visual asset creation at enterprise scale.
          </p>
          <p>
            Unique combination of studio-grade production experience (Disney, National Geographic, Ridley Scott Associates), hospitality brand-building (six successful ventures from concept to exit), and AI-first strategic advisory across health technology, hospitality, and consumer goods.
          </p>
